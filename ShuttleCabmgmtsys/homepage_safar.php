...
<body background ="./images/busback.jpg" >
<!--navbar-->
...
<!--end of navbar-->
<div class= "container-fluid">
  <div class="col-md-4 w3-animate-left" id="darshan" > 
...
<label required class="container">I accept to the terms and conditions
 ...
 <div class="col-md-4 w3-animate-top" id="estimate">
        <div class= "bg-light text-dark">
...
<footer id="footer">
    ...
    <p><b>Submitted by: </b>19BCE2181,20BCE2418,20BCE2426,</p>
